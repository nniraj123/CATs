...
rmse_bs_tmr_alone = np.zeros((len(neurons_arr),bs_size))
...
class CATS(tf.keras.Model):
    ...
    def __init__(self, nvar_ref, nvar_model, J, isreg=False, lmbda=0.01, 
        ...
        if isreg:
            ...
            h11_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h10_mr)
            h12_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h11_mr)
            h13_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h12_mr)
            h14_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h13_mr)
            h15_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h14_mr)
            h16_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h15_mr)
            h17_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h16_mr)
            h18_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h17_mr)
            h19_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h18_mr)
            h20_mr = Dense(nmaxpl, activation=act_fn, use_bias=isbias,
                          kernel_initializer=initializer)(h19_mr)
            out_mr = Dense(nvar_ref, activation=act_fn, use_bias=isbias, 
                           kernel_initializer=initializer)(h20_mr)
...
rmse_bs_tmr_alone[0,:] = bootstrap(residual,size=bs_size)
del states_ANN
...
f"{nhl}HL_{neurons}Neurons_tau={n_mtu}_LRcorrected.nc"
