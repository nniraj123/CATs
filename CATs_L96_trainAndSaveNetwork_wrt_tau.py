...
#n_mtu_arr = np.linspace(0.2,4,20)
...
for tau_n in range(len(n_mtu_arr)):
    ...
    #+-+-+-+-+-+-+-+-+-+-+-+- Save the network +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    #+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    cat_l96.T_rm.save_weights(f"./trained_cats_LRcorrected/L96_trm_tau={n_mtu}.h5")
    cat_l96.T_mr.save_weights(f"./trained_cats_LRcorrected/L96_tmr_tau={n_mtu}.h5")
