...
bs_size = 1000
rmse_bs_MLonly = np.zeros((len(neurons_arr),bs_size))
...
rmse_bs_MLonly[0,:] = bootstrap(residual,size=bs_size)
del states_ANN
gc.collect()
...
fname = f"CATs_L96_RMSE_vs_Neurons_MLonly_{nhl}HL_"+\
f"{neurons_arr[0]}Neurons_tau={n_mtu}_LRcorrected.nc"
